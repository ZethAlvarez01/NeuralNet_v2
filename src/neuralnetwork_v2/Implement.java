...
public class Implement {
 ...
 public double[][] train(double[] input,double[] target){                                              
        ...
        for(int l=neural_net.size()-1;l>=0;l--){
            ...
            */
            ...
            if(l==neural_net.size()-1){
                ...
                // Formula para calcular delta en la Capa L
                // Derivada de la funcion de coste ( valor predicho menos valor real ) por la derivada de la funcion de activacion
                // Delta = derivada_funcion_Coste(a[] - y[]) * derivada_funcion_activacion
                ...
                //Sustituir W y B 
                // Nueva_W  = W_actual + calculo de nueva W
                neural_net.get(l).w=op.add(neural_net.get(l).w, delta_w);
                // Nueva_B  = B_actual + calculo de nueva B
                ...
                */
                ...
                // Formula para calcular delta en la Capa L-n
                // 1. Derivada de la salida de la capa actual
                for(int i=0;i<hidden_o.get(l+1)[0].length;i++){
                ...
                // Guardamos W actual antes de actualizar
                w_aux=new double[neural_net.get(l).w.length][neural_net.get(l).w[0].length];
                w_aux=neural_net.get(l).w;
                ...
                // Actualizamos B
                // Nueva_B = B_actual + calculo nueva B
     ...
     /*
        ...
        Yp: 0: Error cuadratico medio
        Yp: 1: Derivada del error cuadratico medio
